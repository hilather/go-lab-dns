...
The architecture recommends a DNS library behind `internal/dnswire` and the official MCP Go SDK behind `internal/control/mcp`. Pins: `github.com/miekg/dns v1.1.73` and `github.com/modelcontextprotocol/go-sdk v1.8.0` (MCP protocol 2026-07-28 only). Do not spread library-specific types through domain packages.
