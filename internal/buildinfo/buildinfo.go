...
const (
	ConfigAPIVersion = "labdns.dev/v1alpha1"
	RESTPrefix       = "/v1"
	MCPProtocol      = "2026-07-28"
	ChaosAlgorithm   = "hash-v1"
)
...
func (i Info) String() string {
	return fmt.Sprintf("labdns %s commit=%s built=%s config=%s rest=%s mcp=%s chaos=%s",
		i.Version, i.Commit, i.BuildTime, i.Protocols.ConfigAPI, i.Protocols.REST, i.Protocols.MCP, i.Protocols.Chaos)
}
